...
import { HiOutlineUser, HiOutlineMail, HiOutlineIdentification, HiOutlineShieldCheck, HiOutlinePencil, HiOutlineKey } from 'react-icons/hi';
...
export default function AdminProfile() {
    ...
    const profileFields = [
        ...
        { label: 'Role', value: user?.role, icon: HiOutlineShieldCheck },
    ];
        ...
        <div className="max-w-2xl mx-auto space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">Your admin account details</p>
                </div>
                ...
                <div className="divide-y divide-gray-100">
                    ...
                    {editing && (
                        <div className="px-6 py-4 space-y-3">
                            {error && (
                                <div className="p-2 rounded-lg bg-red-50 border border-red-200 text-red-600 text-sm">{error}</div>
                            )}
                            <div>
                            ...
                            <div className="flex justify-end gap-2">
                                <button onClick={handleCancel} className="px-4 py-2 text-sm font-medium text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
                                    Cancel
                                </button>
