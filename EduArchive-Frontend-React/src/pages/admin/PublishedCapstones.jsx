...
import {
    ...
    HiOutlineViewGrid, HiOutlineViewList, HiOutlineUser,
    HiOutlineTag, HiOutlineCalendar, HiOutlineAcademicCap, HiOutlineChevronDown,
} from 'react-icons/hi';
import {
    getCapstones, getCapstoneFilterOptions, toggleBookmark, getAdminBookmarkedCapstones,
} from '../../api/admin';
...
export default function UploadedCapstones() {
    ...
    const loadFilters = async () => {
        try {
            const res = await getCapstoneFilterOptions();
    ...
    const openCapstoneViewer = (capId) => navigate(`/admin/capstones/${capId}`);
