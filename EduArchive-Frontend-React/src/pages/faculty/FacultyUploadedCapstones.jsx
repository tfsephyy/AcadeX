                ...
                <div className="flex-1 min-w-0 px-4 lg:px-8 py-6">
                    {loading ? (
                        ...
                        <EmptyState
                            ...
                            description={search || filters.year || filters.program || filters.category || filters.adviser_id ? 'Try adjusting your search or filters.' : 'No capstones have been uploaded yet.'}
