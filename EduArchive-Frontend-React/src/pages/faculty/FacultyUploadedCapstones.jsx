...
import {
    ...
    HiOutlineBookmark, HiOutlineTrash, HiOutlineEye, HiOutlineX, HiOutlineUpload,
} from 'react-icons/hi';
import {
    getPublishedCapstones,
    getPublishedYears,
    getPublishedPrograms,
    getStudentBookmarkedCapstones,
    toggleBookmark,
...
export default function FacultyUploadedCapstones() {
    ...
    const loadFilters = async () => {
        try {
            ...
            const cRes = await getPublishedCapstones({ per_page: 500 });
        ...
        setConfirm({
            ...
            action: async () => {
                try {
                    ...
                    notify.success('Removed from saved folder.');
                    fetchSavedCapstones();
                } catch {
            ...
            <div className="px-4 lg:px-8 pt-6 lg:pt-8 pb-4">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-2">Browse submitted capstone projects.</p>
                    </div>
            ...
            <div className="px-4 lg:px-8 py-6">
                {loading ? (
                    ...
                    <EmptyState
                        ...
                        description={
                            debouncedSearch || filters.program || filters.category
                                ? 'Try adjusting your search or filters.'
                                : 'No capstones available yet.'
                        }
