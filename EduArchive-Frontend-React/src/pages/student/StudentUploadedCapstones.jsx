...
import { getPublishedCapstones, getPublishedYears, getPublishedPrograms, toggleBookmark, getStudentBookmarkedCapstones } from '../../api/admin';
...
export default function StudentUploadedCapstones() {
    ...
    const openCapstoneViewer = (capId) => {
        navigate(`/student/capstones/${capId}`);
    };
            ...
            <div className="px-4 lg:px-8 py-6">
                {loading ? (
                    ...
                    <EmptyState
                        ...
                        description={search || filters.year || filters.program ? 'Try adjusting your search or filters.' : 'No approved capstones available yet.'}
